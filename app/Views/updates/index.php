            ...
            <div class="card bg-base-100 shadow-sm border border-primary">
                <div class="card-body p-5">
                    <div class="flex items-center gap-2 mb-1 flex-wrap">
                        <span class="badge badge-primary font-mono">v1.3.5</span>
                    ...
                    <div class="mt-4 space-y-4">
                        <div>
                            ...
                            <ul class="space-y-1.5 ml-1">
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-success mt-1.5 shrink-0"></span>
                                    <span>Contact form now blocks spam automatically</span>
                                </li>
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-success mt-1.5 shrink-0"></span>
                                    <span>Added Discord and community links across the site</span>
                                </li>
                            </ul>
                        </div>
                        <div>
                            <div class="flex items-center gap-2 mb-2">
                                <span class="badge badge-info badge-sm gap-1"><i class="fa-solid fa-arrow-up text-[10px]"></i>Improvements</span>
                                <span class="text-xs text-base-content/40">6</span>
                            </div>
                            <ul class="space-y-1.5 ml-1">
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-info mt-1.5 shrink-0"></span>
                                    <span>Redesigned login and sign-up pages</span>
                                </li>
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-info mt-1.5 shrink-0"></span>
                                    <span>Refreshed the home page, navigation menu, and footer</span>
                                </li>
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-info mt-1.5 shrink-0"></span>
                                    <span>Cleaner FAQ, About, Contact, and legal pages</span>
                                </li>
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-info mt-1.5 shrink-0"></span>
                                    <span>Better VIP Guests page - see requirements and rewards for every guest type</span>
                                </li>
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-info mt-1.5 shrink-0"></span>
                                    <span>Support chat now groups messages by day and supports multi-line replies</span>
                                </li>
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-info mt-1.5 shrink-0"></span>
                                    <span>Daily bonus now tracks real-day streaks for fairer rewards</span>
                                </li>
                            </ul>
                        </div>
                        <div>
                            <div class="flex items-center gap-2 mb-2">
                                <span class="badge badge-warning badge-sm gap-1"><i class="fa-solid fa-wrench text-[10px]"></i>Bug Fixes</span>
                                <span class="text-xs text-base-content/40">7</span>
                            </div>
                            <ul class="space-y-1.5 ml-1">
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-warning mt-1.5 shrink-0"></span>
                                    <span>Daily bonus could get stuck and stop letting you claim</span>
                                </li>
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-warning mt-1.5 shrink-0"></span>
                                    <span>Some tutorial steps could not be completed</span>
                                </li>
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-warning mt-1.5 shrink-0"></span>
                                    <span>Snow quality and auto-grooming now work correctly</span>
                                </li>
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-warning mt-1.5 shrink-0"></span>
                                    <span>Corrected outdated info on several pages</span>
                                </li>
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-warning mt-1.5 shrink-0"></span>
                                    <span>Fixed the Compliance page failing to load</span>
                                </li>
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-warning mt-1.5 shrink-0"></span>
                                    <span>Fixed Ski Patrol and Emergency pages crashing with incident history</span>
                                </li>
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-warning mt-1.5 shrink-0"></span>
                                    <span>Fixed daily bonus indicator showing incorrectly on the dashboard</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="card-body p-5">
                    ...
                    <div class="mt-4 space-y-4">
                        <div>
                            <div class="flex items-center gap-2 mb-2">
                                <span class="badge badge-success badge-sm gap-1"><i class="fa-solid fa-plus text-[10px]"></i>New Features</span>
                                <span class="text-xs text-base-content/40">8</span>
                            </div>
                            <ul class="space-y-1.5 ml-1">
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-success mt-1.5 shrink-0"></span>
                                    <span>In-game support chat between players and admin</span>
                                </li>
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-success mt-1.5 shrink-0"></span>
                                    <span>Season 4 resort voting system</span>
                                </li>
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-success mt-1.5 shrink-0"></span>
                                    <span>Combined Compliance page (Insurance + Government + Environment)</span>
                                </li>
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-success mt-1.5 shrink-0"></span>
                                    <span>Cmd+K search modal with categories and keyboard navigation</span>
                                </li>
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-success mt-1.5 shrink-0"></span>
                                    <span>HKD Snowmakers added (Impulse R5, Diablo, Phazer)</span>
                                </li>
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-success mt-1.5 shrink-0"></span>
                                    <span>Season roadmap on home page</span>
                                </li>
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-success mt-1.5 shrink-0"></span>
                                    <span>Daily bonus badge in navbar</span>
                                </li>
                                <li class="flex items-start gap-2 text-sm text-base-content/80">
                                    <span class="w-1.5 h-1.5 rounded-full bg-success mt-1.5 shrink-0"></span>
                                    <span>Admin feature flag bulk controls and search</span>
                                </li>
                            </ul>
                        </div>
                    </div>
