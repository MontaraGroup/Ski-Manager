...
<div class="max-w-3xl mx-auto p-4 lg:p-8">
    ...
    <div class="prose prose-sm max-w-none">
        ...
        <p>Accounts remain the property of Ski Manager. Users are granted a limited license to access and use their accounts in accordance with these Terms. We reserve the right to refuse registration, suspend, or terminate accounts at our discretion.</p>
        ...
        <p>All content, design, code, graphics, game mechanics, text, and branding of Ski Manager are owned by us or our licensors and are protected by copyright, trademark, and other intellectual property laws. Certain trail map imagery and related materials are used under license from Mapsynergy and remain the property of their respective owners. You may not reproduce, distribute, modify, or create derivative works from our content without prior written permission.</p>
        ...
        <h2>9. Copyright Claims</h2>
        <p>If you believe content on the Service infringes your copyright, please contact us at <a href="mailto:contact@ski-manager.net">contact@ski-manager.net</a> with sufficient information to investigate and respond to the claim.</p>
        ...
        <p>We shall not be liable for any delay or failure to perform resulting from causes beyond our reasonable control, including natural disasters, internet outages, governmental actions, labor disputes, or failures of third-party services.</p>

        <h2>18. Early Access</h2>
