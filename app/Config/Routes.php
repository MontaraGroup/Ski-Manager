...
$routes->post("/admin/seasons/activate/(:num)", "Admin::activateSeason/$1");
...
$routes->post("/genepis/exchange", "Genepis::exchange");
...
$routes->post("/grooming/groom-single", "Grooming::groomSingle");
$routes->post("/grooming/groom-critical", "Grooming::groomCritical");
$routes->post("/grooming/groom-sector", "Grooming::groomSector");
